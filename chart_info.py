...
CHART_INFO = {
    "check_sheet": {
        "dropdown_value": "check_sheet",
        "chart_type": "Check Sheet",
        "data_type": "Manual Tally",
        "description": "A manual data collection tool used to tally occurrences of events or defects in real time.",
        "short_description": "Manual data collection tool for tallying occurrences of events.",
        "data_volume": "Real-time tracking",
        "subgroup_size": "Not applicable",
        "monitors": "Real-time defect/event counts",
        "interpretation_rules": ["Use to identify the most common defects before performing a Pareto analysis."],
        "practical_notes": ["Counts are stored temporarily in your browser and will reset if you refresh the page."],
    },
    "pareto": {
        "dropdown_value": "pareto",
        "chart_type": "Pareto Chart",
        "data_type": "Categorical & Frequency",
        "description": "A bar and line chart highlighting the most frequent occurrences (the vital few vs. the trivial many).",
        "short_description": "Highlights the most frequent occurrences using the 80/20 rule.",
        "data_volume": "Any",
        "subgroup_size": "Not applicable",
        "monitors": "Relative frequency and cumulative impact of problems.",
        "interpretation_rules": ["Focus improvement efforts on the tallest bars on the left."],
        "practical_notes": ["Helps prioritize problem-solving efforts."],
    },
    "histogram": {
        "dropdown_value": "histogram",
        "chart_type": "Histogram",
        "data_type": "Variable/Continuous",
        "description": "Visualizes the distribution and frequency of a single continuous variable.",
        "short_description": "Visualizes the distribution and frequency of a continuous variable.",
        "data_volume": "Any",
        "subgroup_size": "Not applicable",
        "monitors": "Distribution, center, and spread of data",
        "interpretation_rules": ["Check for normality, skewness, and multiple peaks."],
        "practical_notes": ["Useful for understanding the overall shape of the data variation."],
    },
    "scatter": {
        "dropdown_value": "scatter",
        "chart_type": "Scatter Diagram",
        "data_type": "Variable/Continuous pairs",
        "description": "Graphs pairs of numerical data to identify potential relationships.",
        "short_description": "Graphs pairs of numerical data to identify potential relationships between two variables.",
        "data_volume": "Any",
        "subgroup_size": "Not applicable",
        "monitors": "Correlation and relationship between variables",
        "interpretation_rules": ["Check for positive, negative, or zero correlation.", "Identify potential outliers."],
        "practical_notes": ["Correlation does not imply causation."],
    },
    "box_plot": {
        "dropdown_value": "box_plot",
        "chart_type": "Box Plot",
        "data_type": "Variable/Continuous",
        "description": "Displays the five-number summary of a set of data to analyze distribution and outliers.",
        "short_description": "Displays the five-number summary to analyze distribution and outliers.",
        "data_volume": "Any",
        "subgroup_size": "Not applicable",
        "monitors": "Distribution, central tendency, spread, and outliers",
        "interpretation_rules": ["Check for symmetry, skewness, and extreme outliers."],
        "practical_notes": ["Useful for comparing distributions across different categories if grouped."],
    },
    "xbar_r": {
